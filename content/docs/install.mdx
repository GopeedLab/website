...
description: Install Gopeed on Windows, macOS, Linux, Android, iOS, Web, Docker and the command line.
---
...
<Callout type="warn">
  If you are deploying on a public IP, please ensure to enable identity
  authentication, otherwise there will be security risks.
</Callout>
...
The command line version requires a `Golang` environment. If you don't have a `Golang` environment installed, you can refer to [here](https://golang.org/doc/install) for installation.
