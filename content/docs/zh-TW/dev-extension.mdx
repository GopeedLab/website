---
title: 擴充開發
description: 學習如何開發 Gopeed JavaScript 擴充、進行本機偵錯，並理解擴充清單與運行機制。
---
...
> 關於`ctx`相關型別定義與擴充原始碼，可以參考[官方 Gopeed JS 倉庫](https://github.com/GopeedLab/gopeed-js)。
...
> 附註：更完整的型別定義與 API 原始碼可以參考[官方 Gopeed JS 倉庫](https://github.com/GopeedLab/gopeed-js)。
