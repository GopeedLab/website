---
title: API 对接
description: 了解如何使用 Gopeed HTTP API 和官方 SDK 创建、管理与集成下载任务。
---
...
更多使用方法、源码与包更新请参考[官方 Gopeed JS 仓库](https://github.com/GopeedLab/gopeed-js)。
...
当然也可以直接通过 HTTP 请求来调用 API，具体请参考 [接口文档](/docs/openapi)。
